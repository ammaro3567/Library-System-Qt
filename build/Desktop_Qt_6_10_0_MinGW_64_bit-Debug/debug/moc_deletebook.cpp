...
namespace {
struct qt_meta_tag_ZN10DeleteBookE_t {};
} // unnamed namespace

template <> constexpr inline auto DeleteBook::qt_create_metaobjectdata<qt_meta_tag_ZN10DeleteBookE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<DeleteBook, qt_meta_tag_ZN10DeleteBookE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DeleteBook::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DeleteBookE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DeleteBookE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN10DeleteBookE_t>.metaTypes,
    nullptr
} };
...
void *DeleteBook::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN10DeleteBookE_t>.strings))
